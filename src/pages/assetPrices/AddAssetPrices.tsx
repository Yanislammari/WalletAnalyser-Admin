...
export default function AddAssetPricesForm({ handleSend, form, setForm, loading }: AccordionFormProps) {
  ...
  return (
    <div className="accordion-wrapper">
      <button className="accordion-toggle" onClick={() => setOpen((o) => !o)}>
        ...
        <span>Create an asset price</span>
      </button>
      ...
      {open && (
        <div className="accordion-body">
          <div className="accordion-name-row">
            <div className="accordion-field">
              ...
              <DatePicker
                ...
                selected={form.asset_price_date}
                onChange={(date: Date | null) => setForm((f) => ({ ...f, asset_price_date: date }))}
                onChangeRaw={(e) => {
            ...
            <div className="accordion-field">
              <label className="accordion-label">Asset price</label>
              <input
                className="accordion-input"
                type="number"
                value={form.asset_price ?? ""}
                onChange={(e) => setForm((f) => ({ ...f, asset_price: Number(e.target.value) }))}
                placeholder="123.45"
                disabled={loading}
              />
            </div>
          ...
          <ConfirmDialog
            title="Add an asset price"
            description="This will create an asset price entry, you can still delete it at any time"
