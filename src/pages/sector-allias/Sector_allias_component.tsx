...
import type { SectorNameAlliasResponse } from "../../payloads/SectorPayload";
...
export interface SectorAlliasRowProps {
  sector_allias: SectorNameAlliasResponse;
  onSave?: (id: string, newName: string) => void;
  onDelete?: (id: string) => void;
  onClick?: () => void;
}

export function SectorAlliasRow({ sector_allias, onSave, onDelete, onClick }: SectorAlliasRowProps) {
  return (
    <tr onClick={()=>onClick?.()}>
      <EditToggle
        value={sector_allias.sector_allias_name}
        onSave={(newName) => onSave?.(sector_allias.uuid, newName)}
        onDelete={() => onDelete?.(sector_allias.uuid)}
      />
    </tr>
  );
}