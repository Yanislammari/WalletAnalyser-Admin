...
export default function AddSectorForm({ handleSend, form, setForm, loading }: AccordionFormProps) {
        ...
        <div className="accordion-body">
          ...
          <div className="accordion-name-row">
            <div className="accordion-field">
              <label className="accordion-label">Sector name</label>
              <input
                className="accordion-input"
                type="text"
                value={form.sector_name}
                onChange={(e) => setForm(() => ({ sector_name: e.target.value }))}
          ...
          <ConfirmDialog
            title="Add a sector"
            description="This will create a sector, you can stil delete it at any time"
