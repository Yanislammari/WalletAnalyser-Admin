...
export default function AddCountryAlliasForm({ handleSend, form, setForm, loading }: AccordionFormProps) {
  ...
  return (
    <div className="accordion-wrapper">
      ...
      <button className="accordion-toggle" onClick={() => setOpen((o) => !o)}>
        ...
        <span>Create a country allias</span>
      </button>
        ...
        <div className="accordion-body">
          ...
          <div className="accordion-name-row">
            <div className="accordion-field">
              <label className="accordion-label">Country allias name</label>
              <input
                className="accordion-input"
                type="text"
                value={form.country_allias_name}
                onChange={(e) => setForm(() => ({ country_allias_name: e.target.value }))}
                placeholder="Fr"
                disabled={loading}
              />
            </div>
          ...
          <ConfirmDialog
            title="Add a country"
            description="This will create a country allias, you can stil delete it at any time"
